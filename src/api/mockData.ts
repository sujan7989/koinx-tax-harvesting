...
/**
 * Holdings data from the assignment spec.
 * All gain values are computed as: gain = (currentPrice - averageBuyPrice) × balance
 * Full floating-point precision is preserved — no rounding at data layer.
 * Formatting/display rounding happens only in the UI (format.ts).
 */
...
export const HOLDINGS_DATA: Holding[] = [
  {
    ...
    stcg: {
      ...
      gain: (85.41 - 1.5863185433764244) * 0.0015339999999994802,
    },
  ...
  },
  {
    ...
    stcg: {
      ...
      gain: (211756 - 3599.856066001555) * 0.00023999998390319965,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (14758.01 - 221.42847548590152) * 3.469446951953614e-17,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (22.08 - 0.5227311370876341) * 1.3172764293128694,
    },
    ltcg: {
      balance: 1,
      gain: (22.08 - 0.5227311370876341) * 1,
    },
  },
  {
    coin: 'MATIC',
    ...
    stcg: {
      ...
      gain: (22.22 - 0.6880274617804887) * 2.75145540184285,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (0.0001462 - 0.00001637624055112482) * 696324.3075326696,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (85.42 - 1.4988059369185402) * 0.0001580000000558357,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (85.41 - 1.5405071277176852) * 0.005806999999992795,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      balance: 0.01,
      gain: (6.66 - 4.999247835735738) * 0.01,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      balance: 5,
      gain: (0.13319 - 0.018408606024462898) * 5,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (0.355985 - 0.07889041030290807) * 1.4210854715202004e-14,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
  ...
  },
  {
    ...
    stcg: {
      ...
      gain: (216182 - 3909.792264648455) * 0.0004211938732637162,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (2319.83 - 65.86759737193783) * 5.961538207532868e-11,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (0.300613 - 0.03486178524947315) * 3.1178615245153196e-11,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (1450.14 - 9.172984515948809) * 0.000047233224826389,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (0.02974533 - 0.005182145656093) * 9.822542779147625e-11,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (0.00729945 - 0.011065778585432803) * 2.2737367544323206e-13,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (17.51 - 0.25960465528043797) * 3.325212327709437e-11,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (0.060863 - 0.01520546569793174) * 1.063542780948968,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (52.99 - 1.7040326829291739) * 0.04265758808550148,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (0.885074 - 6.539367177529248) * 0.0005424384664524931,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      ...
      gain: (0.093794 - 0.453964789704584) * 6.442993445432421e-7,
    },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    ...
    stcg: {
      balance: 8.861,
      gain: (8.65643e-7 - 8.531798889329416e-7) * 8.861,
    },
    ltcg: { balance: 0, gain: 0 },
  },
];

// Capital Gains — exact values from the assignment spec
